...
export const metadata: Metadata = {
  title: "Webild Studio | Premium Digital Design & Strategy",  description: "Elevate your brand with sophisticated digital design and strategic solutions. Premium web design, branding, and digital strategy services.",  keywords: "web design, brand design, digital strategy, luxury design, studio design",  openGraph: {
    title: "Webild Studio | Premium Digital Design",    description: "Transform your digital presence with elegant design and strategic innovation.",    siteName: "Webild",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/modern-office-space-with-futuristic-decor-furniture_23-2151797631.jpg",        alt: "Webild Studio"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Webild Studio",    description: "Premium digital design and strategy services",    images: ["http://img.b2bpic.net/free-photo/modern-office-space-with-futuristic-decor-furniture_23-2151797631.jpg"]
  },
  robots: {
    index: true,
    follow: true
